...
A collection of open-source Python modules developed as part of the **Secuditor project** is available in the **[open_scripts](/open_scripts)** folder, licensed under the [MIT License](/open_scripts/LICENSE.txt) (applicable only to this folder).
